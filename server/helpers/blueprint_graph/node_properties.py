...
def set_function_call(
    ...
    WARNING: This operation is destructive and will disconnect all pins connected to the
...
def set_event_type(
    ...
    WARNING: This operation is destructive and will disconnect all pins. Only use when
